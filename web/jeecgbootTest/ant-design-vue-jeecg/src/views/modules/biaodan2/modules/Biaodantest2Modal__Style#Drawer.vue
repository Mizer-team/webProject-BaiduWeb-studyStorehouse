  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/test3/biaodantest2/add",
          edit: "/test3/biaodantest2/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','age','email'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','age','email'))
      }
